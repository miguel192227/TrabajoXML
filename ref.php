...
<body>
  <center>
    <div class="linea">
<button class="kratos" onclick="cerrar()">cerrar cesion</button>
</div >
<div class="a">
  <label>Nombre de la cancion:<input class="war" type="text" id="te2" name="nombre"></label><br>  
...
<div id="container" class="ghost">
	<div id="result" class="tree"></div>
</div>
<div id="container" class="ghost">
		<div id="result2" class="tree"></div>
